...
public class RegisterAndEditAdministratorTest extends AbstractTest {
	 ...
	 * Negative:An actor who is authenticated as Hacker can not register other administrator
		...
		final Object testingData[][] = {
			{
				...
				"prueba1", "123456", "123456", "prueba1", "prueba", "", "prueba@prueba.com", "600102030", "", 21, "prueba1", "MASTERCARD", "5473259551394900", "2026/10/20", 841, "hacker1", IllegalArgumentException.class
			}
		};
	 ...
	 * Negative:An actor who is authenticated as Hacker can not edit edit personal data of any administrator
		...
		final Object testingData[][] = {
			{
				...
				"hacker1", "newName", NullPointerException.class
			}
		};
		for (int i = 0; i < testingData.length; i++)
