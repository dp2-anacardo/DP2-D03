...
public class ApplicationTest extends AbstractTest {
    ...
    public void createApplicationDriver() {
        final Object testingData[][] = {
                {
                        "hacker1", "position1", "curricula2Hacker1", null
                }, {
                "hacker1", "position1", "", AssertionError.class
                }, {
                "hacker1", "position2", "curricula2Hacker1", IllegalArgumentException.class
                }, {
                "hacker1", "position3", "curricula2Hacker1", IllegalArgumentException.class
        }
        };
        for (int i = 0; i < testingData.length; i++)
    ...
    public void updateApplicationDriver() {
        final Object testingData[][] = {
                {
                        "hacker2", "application4", "explanation","http://www.link.com", null
                }, {
                "hacker2", "application4", "", "", IllegalArgumentException.class
        }, {
                "hacker2", "application1", "explanation", "http://www.link.com", IllegalArgumentException.class
        }, {
                "hacker1", "application2", "explanation", "http://www.link.com", IllegalArgumentException.class
        }, {
                "hacker1", "application3", "explanation", "http://www.link.com", IllegalArgumentException.class
        }
        };
        for (int i = 0; i < testingData.length; i++)
    ...
    private void updateApplicationTemplate(final String username, final String application, final String explanation, String link, final Class<?> expected) {
        ...
        try {
            ...
            a.setLink(link);
            this.applicationService.saveHackerUpdate(a);
