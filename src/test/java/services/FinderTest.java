...
public class FinderTest extends AbstractTest {
    ...
    public void updatingFinderDriver() {
        final Object testingData[][] = {
                {
                        "hacker1", "finderHacker1", "keyword", null
                }, {
                "hacker2", "finderHacker1", "keyword", IllegalArgumentException.class
                }, {
                "company1", "finderHacker1", "keyword", IllegalArgumentException.class
        }
        };
    ...
    public void cleaningFinderDriver() {
        final Object testingData[][] = {
                {
                        "hacker1", "finderHacker1", null
                }, {
                "hacker2", "finderHacker1", IllegalArgumentException.class
        }, {
                "company1", "finderHacker1", IllegalArgumentException.class
        }
        };
        for (int i = 0; i < testingData.length; i++)
