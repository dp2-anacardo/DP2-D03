...
public class SocialProfileController extends AbstractController {
    ...
    public ModelAndView list() {
        ...
        result = new ModelAndView("socialProfile/admin,company,hacker/list");
        result.addObject("socialProfiles", profiles);
        result.addObject("requestURI", "socialProfile/admin,company,hacker/list.do");
    ...
    protected ModelAndView createEditModelAndView(final SocialProfile profile, final String messageCode) {
        ...
        ModelAndView result;
        result = new ModelAndView("socialProfile/admin,company,hacker/edit");
