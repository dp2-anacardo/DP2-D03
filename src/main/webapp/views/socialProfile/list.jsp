...
<security:authorize access="hasAnyRole('ADMIN, COMPANY, HACKER')">
    <display:table pagesize="5" class="socialProfiles" name="socialProfiles" requestURI="${requestURI}" id="row">


        <display:column> <a href="socialProfile/admin,company,hacker/edit.do?socialProfileId=${row.id}">
    ...
    <input type="button" value="<spring:message code="socialProfile.create" />"
           onclick="javascript: relativeRedir('socialProfile/admin,company,hacker/create.do');" />
